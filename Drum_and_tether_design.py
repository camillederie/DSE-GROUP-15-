...
def drum_sizing(double_winding , angle, oper_range, tether_d, saf_marg, dD_dT, extra_len): 
    ...
    if double_winding:
        ...
        len_drum = max(len_drum_oper,len_drum_start)
...
saf_fac = 2         
nom_load= 10329.316 #10192 #10084.273 #11500 #12000 #15308.556 #14000.11188 #16219.636
...
kite_area = [20.16]                 # m^2
reel_out_perc = 89                  #Update when possible
avg_strut_A = 0.6867                # m^2
...
print(f'{"Tether volume = "}{655*(diam/2)**2*pi}{" m^3"}')
...
print(f'{"Kite weight with ALUULA canopy = "}{(total_weight(kite_area, DA_weight, extrapolation_perc(kite_area))+ canopy_weight(kite_area, AL_weight)[0]-canopy_weight(kite_area, DA_weight)[0])}{" kg"}')
